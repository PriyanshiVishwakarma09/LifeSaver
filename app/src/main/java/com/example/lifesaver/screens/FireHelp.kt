...
@Composable
fun FireEmergencyScreen(
    emergencyNumber: String = "101"
    ...
    Column(
        ...
        StepItem(
            ...
            details = listOf(
                ...
                "Stay low to avoid inhaling smoke and use stairs, not elevators."
            ),
        ...
        StepItem(
            ...
            details = listOf(
                "If fire is small, use extinguisher: Pull, Aim, Squeeze, Sweep (PASS method).",
                "If uncontrollable, do not attempt to fight fire."
            ),
            leadingIcon = Icons.Filled.Whatshot
        )
        StepItem(
            number = "3",
            title = "Call Emergency Services",
            details = listOf(
                "Dial $emergencyNumber immediately once safe.",
                "Provide location, type of fire, and if anyone is trapped."
            ),
        ...
        TipItem(
            ...
            points = listOf(
                ...
                "Install alarms in bedrooms, kitchens, and hallways."
            )
        )
        TipItem(
            title = "Fire Safety Equipment",
            points = listOf(
                "Keep fire extinguisher and fire blanket easily accessible.",
                "Learn basic fire safety training."
            ),
            icon = Icons.Outlined.TipsAndUpdates
        )

        // Action Buttons
        ActionButtons(context, emergencyNumber, "Fire")

        Spacer(Modifier.height(12.dp))
        Text(
            text = "Note: Only attempt firefighting if the fire is small and manageable.",
...
@Composable
fun PreviewFire(){
    FireEmergencyScreen(navController = rememberNavController())
}